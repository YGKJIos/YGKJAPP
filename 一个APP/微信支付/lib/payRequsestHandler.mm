...
- ( NSMutableDictionary *)sendPay_demo:(float)price orderNum:(NSString *)orderNum
{
    ...
    //订单标题，展示给用户
    NSString *order_name    = @"微信支付";
    //订单金额,单位（分）
    int int_price = price *100;
    NSString *order_price   = [NSString stringWithFormat:@"%d", int_price]  ;//1分钱测试
    ...
    NSString *orderno   =  [NSString stringWithFormat:@"%@",orderNum]; //订单号
